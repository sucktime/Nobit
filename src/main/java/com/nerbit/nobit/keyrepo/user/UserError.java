...
public class UserError {
	...
	public static final String ERR_CODE_NO_SUCH_USER = "101";
	public static final String ERR_DISP_NO_SUCH_USER="no such user";
	...
	public UserError(String errcode, String errordisp) {
		super();
